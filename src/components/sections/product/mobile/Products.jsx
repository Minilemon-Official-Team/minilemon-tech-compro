...
export default function Products() {
  ...
  return (
    <div className="relative w-full min-h-screen flex flex-col gap-8 items-center mb-12 px-8">
      <AnimatedCubes
        position={"rotate-8 top-120 -right-24"}
      />

      <AnimatedCubes
        position={"-rotate-12 top-[62%] -left-20"}
      />
