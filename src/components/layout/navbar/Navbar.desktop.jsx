...
export default function NavbarDesktop() {
  ...
  return (
    <div className='w-full px-20'>
      <div className='bg-(--mltBlack) max-w-310 2xl:max-w-400 3xl:max-w-440 mx-auto py-6'>
          ...
          <nav className='bg-white rounded-4xl w-172 2xl:w-184 h-18 2xl:h-21.5'>
            <ul className='flex gap-24 justify-center items-center text-xl 2xl:text-2xl h-full'>
              <li>
                <Link
                  href='/product'
                  className='text-(--mltBlack) hover:text-[#0044FF] hover:border-b-3 hover:border-[#0044FF] pb-1 transition'
                >
                  Products
                </Link>
              </li>
              ...
              <li>
                <Link
                  href='/collab'
                  className='text-(--mltBlack) hover:text-[#0044FF] hover:border-b-3 hover:border-[#0044FF] transition'
                >
                  Collaboration
                </Link>
              </li>
