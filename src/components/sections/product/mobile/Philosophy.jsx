  ...
  return (
    <div className="w-full min-h-screen flex flex-col justify-center text-white relative mb-24 py-24 overflow-hidden">
      <div className="relative w-full max-w-350 mx-auto px-6">
        <div className="absolute -top-4 md:-top-12">
          <AnimatedText text={"OUR COMPANY"} rotate={"-rotate-4"} />
        </div>

        <div className="absolute -bottom-2 md:-bottom-16 left-4 lg:left-0 xl:left-0 2xl:left-2">
          <AnimatedText text={"ABOUT"} rotate={"rotate-8"} />
        </div>

        <div className="absolute -bottom-4 md:-bottom-12 right-20 sm:right-0 md:right-12 sm:left-1/2 sm:-translate-x-1/4">
          <AnimatedText text={"PROFILE"} rotate={"-rotate-4"} />
        </div>

        <div className="absolute top-1/2 -translate-y-1/2 -right-20  mask-[linear-gradient(to_left,black_10%,transparent_90%)]">
          <Image
            alt="Pattern"
